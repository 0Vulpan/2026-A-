...
#define UART1_DMA_RX_IRQHandler         DMA1_Channel4_IRQHandler    
...
#define UART1_RX_DMA_IRQ                DMA1_Channel4_IRQn
#endif
/*
#elif defined(BSP_UART1_RX_USING_DMA) && !defined(UART1_RX_DMA_INSTANCE)
#define UART1_DMA_RX_IRQHandler         DMA1_Channel3_IRQHandler
#define UART1_RX_DMA_RCC                RCC_AHB1ENR_DMA1EN
#define UART1_RX_DMA_INSTANCE           DMA1_Channel3
#define UART1_RX_DMA_REQUEST            DMA_REQUEST_USART1_RX
#define UART1_RX_DMA_IRQ                DMA1_Channel3_IRQn
#endif
*/
